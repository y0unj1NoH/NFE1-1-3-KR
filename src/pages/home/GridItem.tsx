...
const GridItem = ({ src, alt, bookId, onCardClick }: GridItemProps) => {
  ...
  return (
    <div
      className='gallery-item relative cursor-pointer w-full max-w-[300px] aspect-[200/295]'
      data-color={bookColor}
      onClick={() => onCardClick && onCardClick(bookId, bookColor || 'transparent')}
    >
      <div className='relative relative w-full h-full rounded-xl [transform-style:preserve-3d]'>
